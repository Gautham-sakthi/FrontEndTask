    ...
    return (
        <div className="container d-flex my-5 justify-content-center" >
            <form onSubmit={formik.handleSubmit} className="login-form">
                ...
                <label className='mt-2' htmlFor="artist">Artist
                    <input
                        placeholder="Artist"
                        id="artist"
                        name="artist"
                ...
                {formik.errors.artist ? <div className='text-danger'>{formik.errors.artist}</div> : null}


                <label className='mt-2' htmlFor="minutes">Minutes
                    <input
                        id="minutes"
                        name="minutes"
                        type="number"
                ...
                {formik.errors.minutes ? <div className='text-danger'>{formik.errors.minutes}</div> : null}

                <label className='mt-2' htmlFor="seconds">Seconds
                    <input
                        placeholder="Seconds"
                        id="seconds"
                        name="seconds"
                ...
                {formik.errors.seconds ? <div className='text-danger'>{formik.errors.seconds}</div> : null}
                <div className="row d-flex my-5 justify-content-center">
                        <button type="submit" className="btn btn-lg btn-success mr-3">Submit</button>
                        <button type="submit" className="btn btn-lg btn-danger " onClick={
                            ()=>{
                                close();
                            }
                        }>Cancel</button>
